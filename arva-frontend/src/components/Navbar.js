        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-success position-sticky"
                ...
                <div className="container-fluid">
                    <Link className="navbar-brand fs-1 fst-italic" to="/">ArvaCoffee</Link>
                        ...
                        {(!localStorage.getItem("token")) ?
                            ...
                            <div>
                                ...
                                <div className="btn bg-white text-success mx-2 " onClick={loadCart}>
                                    <Badge color="secondary" badgeContent={items.length} style={{"marginTop": "-0.40rem"}}>
                                        <ShoppingCartIcon />
                                    </Badge>
                                    {"   "}  My Cart  {"  "}
                                    <span style={{"color": "white", "background": "red", "borderRadius": "100%", "padding": "0.3rem"}}>{items?.length}</span>
                                </div>
